...
//#include scripts\zm\cmd\t6\sv\zm_bots_cmds;
...
main()
{
	//replaceFunc( maps\_zombiemode_utility::wait_network_frame, ::wait_network_frame_override );
	//replaceFunc( maps\_visionset_mgr::monitor, ::monitor_stub );
	//replaceFunc( maps\_zombiemode_perks::perk_machine_spawn_init, ::perk_machine_spawn_init_hook );
	//replaceFunc( maps\_zombiemode_weapons::show_all_weapon_buys, ::show_all_weapon_buys_override );
...
// 			{
// 				if ( players[ player_index ] _ISTESTCLIENT() )
// 					continue;
...
// 	disabledetouronce( maps\_zombiemode_perks::perk_machine_spawn_init );
