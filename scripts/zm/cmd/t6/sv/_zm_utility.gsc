...
// 		for ( i = 0; i < _SIZE( level._melee_weapons.size ); i++ )
// 		{
// 			melee_weap = level._melee_weapons[ i ];
...
// 	level._dynamically_spawned_active_wallbuys[ internal_name ] = wallbuy_struct;
...
// {
// 	wallbuy_struct = level._dynamically_spawned_wallbuy_structs[ internal_name ];
// 	if ( !isdefined( wallbuy_struct ) )
// 	{
// 		return false;
// 	}
