...
arg_obj_enttype_cast( arg )
{
	...
	for ( i = 0; i < types.size; i++ )
	{
		if ( types[ i ] == "none" )
		{
			...
			return set_cast_success( find, additional_types, "node_type==none" );
		}
	...
	if ( errors > 0 )
	{
		msg = get_possible_array_values_msg( arg, level._entity_type_funcs, "ent_type" );
		return set_cast_error( find, msg );
	}
...
arg_obj_nodetype_cast( arg )
{
	...
	for ( i = 0; i < types.size; i++ )
	{
		...
		if ( types[ i ] == "all" )
		{
			...
			return set_cast_success( find, additional_types, "node_type==all" );
		}
		...
		if ( types[ i ] == "negotiation" )
		{
			...
			return set_cast_success( find, additional_types, "node_type==negotiation" );
		}
	...
	if ( errors > 0 )
	{
		msg = get_possible_array_values_msg( arg, level._node_types, "node_type" );
		return set_cast_error( find, msg );
	}
...
arg_obj_triggertype_cast( arg )
{
	...
	for ( i = 0; i < types.size; i++ )
	{
		if ( types[ i ] == "use" )
		{
			...
			return set_cast_success( find, additional_types, "trigger_type==use" );
		}
		...
		if ( types[ i ] == "touch" )
		{
			...
			return set_cast_success( find, additional_types, "trigger_type==touch" );
		}
		...
		if ( types[ i ] == "box" )
		{
			additional_types[ additional_types.size ] = "box_use";
			additional_types[ additional_types.size ] = "box";
			return set_cast_success( find, additional_types, "trigger_type==box" );
		}
		...
		if ( types[ i ] == "radius" )
		{
			additional_types[ additional_types.size ] = "radius_use";
			additional_types[ additional_types.size ] = "radius";
			return set_cast_success( find, additional_types, "trigger_type==radius" );
		}
	...
	if ( errors > 0 )
	{
		msg = get_possible_array_values_msg( arg, level._trigger_types, "trigger_type" );
		return set_cast_error( find, msg );
	}
