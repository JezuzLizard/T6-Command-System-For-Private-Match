...
hud_binding_set( binding_name, new_value )
{
	...
	_ASSERT_MSG( hud_binding_obj.binding_type == "text", "hud_binding_set: Unhandled binding_type '{}'", hud_binding_obj.binding_type );
...
hud_binding_update( hud_binding_obj, hud )
{
	...
	_ASSERT_MSG( hud_binding_obj.binding_type == "entity", "hud_binding_update: Unhandled binding_type '{}'", hud_binding_obj.binding_type );
	if ( hud_binding_obj.binding_type == "entity" )
	{
		switch ( hud_binding_obj.binding_subtype )
		{
			...
			case "placed_entities":
				...
				break;
			default:
				_ASSERT_MSG_ONLY( "hud_binding_update: Unhandled binding_subtype '{}'", hud_binding_obj.binding_subtype );
				break;
		}
	}
}
