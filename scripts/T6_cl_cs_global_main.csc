...
#include scripts\cmd\t6\cl\core\_cl_cmd_execute;
#include scripts\cmd\t6\cl\core\_cl_cmd_parse2;
#include scripts\cmd\t6\cl\core\_cl_com;
#include scripts\cmd\t6\cl\core\_cl_consts;
