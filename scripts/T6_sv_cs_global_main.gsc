...
#include scripts\cmd\t6\sv\core\_cmd_execute;
#include scripts\cmd\t6\sv\core\_cmd_parse2;
#include scripts\cmd\t6\sv\core\_com;
#include scripts\cmd\t6\sv\core\_consts;
#include scripts\cmd\t6\sv\core\_perms;
#include scripts\cmd\t6\sv\core\_utility;
#include scripts\cmd\t6\sv\core\unittest;

// common cmds
#include scripts\cmd\t6\sv\modules\core_cmds;
// entity cmds
#include scripts\cmd\t6\sv\modules\entity_cmds;
// filmmaker cmds
//#include scripts\cmd\t6\sv\modules\filmmaker\camera_cmds;
// debug cmds
#include scripts\cmd\t6\sv\modules\debug_cmds;
